// length of array is number of chapters, array elements are verses in chapter by index
// Precalculated Python version for the ESV: https://gist.github.com/eykd/842200
export const counts: Record<Book, number[]> = {
  Genesis: [
